...
void initialize_example_module(ModuleInitializationLevel p_level) {
	...
	ClassDB::register_class<GDState>();
	ClassDB::register_class<GDStateMachine>();
	ClassDB::register_class<BossPattern1>();
	ClassDB::register_class<BossStagger>();
	ClassDB::register_class<BossPattern2>();
}
